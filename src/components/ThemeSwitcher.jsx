...
export default function ThemeSwitcher({ themeId, onChange }) {
  ...
  return (
    <div className="bg-rage-card rounded-2xl border border-rage-filled p-4">
      <div className="flex items-center justify-between mb-3">
        <span className="text-sm text-gray-400">🎨 視覺風格</span>
        <span className="text-xs text-gray-600 italic">{current.desc}</span>
      </div>
